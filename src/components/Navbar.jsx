...
export default function Navbar() {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.3 }} // تصحيح الانتقال
      ...
      <motion.nav
        ...
        <div className="hidden nav:block mt-3">
          <ul className="flex gap-5">
            ...
            <motion.li initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }}><Link className="Links" to='/Login'>Login</Link></motion.li>
            <motion.li initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }}><Link className="Links" to='/Signup'>Sign Up</Link></motion.li>
          </ul>
        </div>
        ...
        <div className='lg:flex-grow'>
          <motion.form
            ...
            className="bg-gray-100 p-1 px-3 rounded-full hidden nav:flex mt-3 gap-2"
        ...
        <motion.div
          ...
          className="flex gap-3 xsm:mt-3 items-center">

          <Link to='/Login' className="hidden md:block px-4 py-2 text-sm font-medium text-white bg-black rounded-md hover:bg-gray-400 transition duration-200">Login</Link>
          <Link
            to='/SignUp'
